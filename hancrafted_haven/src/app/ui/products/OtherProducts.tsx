...
//const OtherProducts = (otherProductData: Product[], otherProductImages: Image_[], OtherProductReviews: Review_[]) => { 

//    //!  Call the fetch Images and fetch Reviews for each product in this component, then map out to the cards??
